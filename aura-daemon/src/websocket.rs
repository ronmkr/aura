...
//! internal event bus as specified by [ADR-0004](aura-docs/manual/src/adr/0004-telemetry-and-event-bus.md).
...
/// real-time telemetry events from the core event bus as specified in [ADR-0004](aura-docs/manual/src/adr/0004-telemetry-and-event-bus.md).
