...
//! a designated sandbox directory, enforcing [Decision-0054](aura-docs/manual/src/decisions/0054-sandbox-root-confinement.md).

use crate::Result;
use std::path::{Path, PathBuf};

/// Enforces sandbox path confinement rules to prevent directory traversal and isolate
/// file system operations, complying with the security design in [Decision-0054](aura-docs/manual/src/decisions/0054-sandbox-root-confinement.md).
