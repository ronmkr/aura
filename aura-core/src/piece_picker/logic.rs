...
//! Also implements BitTorrent Endgame Mode as specified in [Decision-0039](aura-docs/manual/src/decisions/0039-bittorrent-endgame-mode.md).
...
/// Implements the BitTorrent Endgame Mode strategy detailed in [Decision-0039](aura-docs/manual/src/decisions/0039-bittorrent-endgame-mode.md).
#[derive(Debug)]
