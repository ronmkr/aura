...
2.  **Architecture (ADRs)**: Significant architectural changes require a new Architecture Decision Record in `docs/adr/`.
3.  **Glossary**: Update `docs/project/CONTEXT.md` if you introduce new domain concepts.
